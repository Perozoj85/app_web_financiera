  ...
  const exportToPDF = () => {
    ...
    try {
      ...
      const footPDF = [[
        ...
        { content: `${CURRENCIES[currencyKey].symbol}${formatPDFValue(montoFinanciar)}`, styles: { halign: 'center' } },
        { content: '', styles: { halign: 'center' } },
        { content: `${CURRENCIES[currencyKey].symbol}${formatPDFValue(financialData.totalIntereses)}`, styles: { halign: 'center' } },
        { content: `${CURRENCIES[currencyKey].symbol}${formatPDFValue(financialData.totalPagado)}`, styles: { halign: 'center', fontStyle: 'bold' } }
      ]];
      ...
      autoTable(doc, {
        ...
        footStyles: { fillColor: [241, 245, 249], textColor: [15, 23, 42], fontSize: 8, fontStyle: 'bold', halign: 'center' },
        ...
        didDrawPage: (data) => {
          ...
          doc.text('Simulación de amortización de carácter puramente informativo. Sujeto a aprobación crediticia.', 15, 284);
          ...
          <div className="flex items-center space-x-3.5">
            <div>
              <h1 className="text-xl md:text-2xl font-black tracking-tight flex items-center gap-2">
                CRÉDITO<span className="font-light text-slate-300">FINANCIERO</span>
              </h1>
            ...
            <div className="p-5 flex flex-col gap-4">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 flex justify-between items-center shadow-inner">
                <div>
                  ...
                  <span className="text-xs text-slate-500">(Valor Auto - Enganche)</span>
                </div>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tfoot className="bg-slate-150 border-t-2 border-slate-300 text-xs font-mono">
                    <tr className="font-extrabold text-slate-800">
                      ...
                      <td className="py-3 px-4 text-center">{formatCurrency(montoFinanciar)}</td>
                      <td className="py-3 px-4 text-center text-slate-400 italic">-</td>
                      <td className="py-3 px-4 text-center text-amber-700">{formatCurrency(financialData.totalIntereses)}</td>
                      <td className="py-3 px-4 text-center bg-slate-200/50">{formatCurrency(financialData.totalPagado)}</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
